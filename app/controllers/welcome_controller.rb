...
# of the class name.
# the generator command: rails g controller WelcomeController# also, the file
# name is important, it should match the class name with snake case convention
# by default Rails controller inherit from 'ApplicationController'
