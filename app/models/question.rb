...
class Question < ApplicationRecord
  ...
  # by default belongs_to adds a validation to verify that the association exists
  # validates :category_id, presence: true

  # It's highly recommended that you add the 'dependent' option to the
  # association which tells Rails what to do when you delete a Question
  # that has answers associated to it, the most popular options are:
  ...
  #              answers to be "NULL" before deleting the question
